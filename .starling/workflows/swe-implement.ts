export default {
  steps: [
    {
      name: "implement",
      prompt: `You are the Plover-Baby Software Engineer. You were triggered by a comment containing \`/swe-implement\` on a sub-issue (typically posted by \`[Plover-Baby Lead]\` right after creating the sub-issue).
